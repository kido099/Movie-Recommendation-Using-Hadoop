...
class MovieSimilarities(MRJob):
    ...
    def load_movie_names(self):
        ...
        self.movieNames = {} # dictionary
        
        with open("movies.dat") as f:
            for line in f:
                fields = line.split('::')
                if(fields[0] != 'movieId'): # skip first line
                    self.movieNames[int(fields[0])] = fields[1] # movieID, movieName
    ...
    def reducer_compute_similarity(self, moviePair, ratingPairs):
        # Compute the similarity score between the rating vectors
        ...
        # Enforce a minimum score and minimum number of co-ratingsto ensure quality
        if(numPairs > 10 and score > 0.85):
    ...
    def mapper_sort_similarities(self, moviePair, scores):
        ...
        # so we have the meaningful sorted results
        score, n = scores
